        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full pt-28">
            <div class="max-w-2xl py-16">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('admin.quick-login') }}"
                        class="inline-flex items-center gap-2 rounded-lg bg-white/10 backdrop-blur-sm px-5 py-2.5 text-sm font-bold text-white border border-white/20 hover:bg-white/20 transition-colors">
                        Accès Rapide Admin
                    </a>
                </div>
