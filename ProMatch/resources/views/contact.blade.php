...
@section('title', 'ProMatch — Contactez-nous')
    ...
    <main class="pt-32 pb-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <!-- Contact Info -->
                <div class="bg-slate-900 rounded-3xl p-8 lg:p-12 text-white relative overflow-hidden">
                    <!-- Background Pattern -->
                    ...
                    <div class="relative z-10 space-y-8">
                            ...
                            <ul class="space-y-6">
                                ...
                                <li class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slate-400 mt-1">+212 6 12 34 56 78</p>
                                        <p class="text-sm text-slate-500 mt-1">Du Lundi au Dimanche, 9h - 23h</p>
                                    </div>
                                </li>
                                <li class="flex items-start gap-4">
                                    <div class="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-slate-400 mt-1">contact@promatch.ma</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="pt-8 border-t border-white/10">
                            <h4 class="text-sm font-bold uppercase tracking-wider mb-4">Suivez-nous</h4>
                            <div class="flex gap-4">
                                <a href="#" class="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-brand-600 transition-colors">
                                    <!-- Social Icons -->
