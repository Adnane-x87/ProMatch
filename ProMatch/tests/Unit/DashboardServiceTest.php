...
class DashboardServiceTest extends TestCase
{
    ...
    public function test_can_get_dashboard_stats()
    {
        ...
        $tenant1 = Tenant::create(['user_id' => $tenantUser1->id, 'is_cni_valid' => true, 'cni_image' => 'url1']);

        $tenantUser2 = User::create(['first_name' => 'T2', 'last_name' => 'U2', 'email' => 't2@t.com', 'password' => '1', 'phone' => '2']);
        $tenant2 = Tenant::create(['user_id' => $tenantUser2->id, 'is_cni_valid' => false, 'cni_image' => 'url2']);
